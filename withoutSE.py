...
import math
import os
from model.parallel_2dcnn_1dcnn import build_model
...
def main():
    ...
    parser.add_argument('--save_path', type=str, default='result/txt/withoutSE.txt', help='path of saved result')
    parser.add_argument('--save_model', type=str, default='result/model/withoutSE_{}.h5', help='path of saved model result')
