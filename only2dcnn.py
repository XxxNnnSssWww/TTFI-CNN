...
import math
import os
from model.model_2dcnn import build_model
...
def main():
    ...
    parser.add_argument('--save_path', type=str, default='result/txt/only2dcnn.txt', help='path of saved result')
    parser.add_argument('--save_model', type=str, default='result/model/only2dcnn_{}.h5', help='path of saved model result')
    ...
    file = open(args.save_path, "a")
    file.write(
        '1.5s redata mfcc ecanet only2dcnn:' + '\n'
